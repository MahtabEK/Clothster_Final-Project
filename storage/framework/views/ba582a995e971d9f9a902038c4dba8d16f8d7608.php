...
<div class="navigation">
    <a id="navigation_member_button" style="text-decoration:none;" href="<?php echo e(url('/register')); ?>">عضویت</a>
    
    <a id="navigation_login_button" style="text-decoration:none;" href="<?php echo e(url('/login')); ?>">ورود</a>
