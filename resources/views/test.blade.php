...
<head>
    ...
    {!!HTML::style('css/productListF.css')!!}
    {!! HTML::script('js/productList.js')!!}
</head>
    ...
    <div id="slideshow-container">
        <div class="mySlides">
            ...
            <div class="pack1">
                ...
                <p class="brand_name1">ARMANI</p>
                <p class="product_name1">سوئیشرت</p>
                <strike class="before_off1">200</strike>
                <p class="after_off1">180</p>
                <p class="toman1">تومان</p>
            </div>

            <!--row1col2-->
            <div class="pack1" id="pack2">
                <img class="pack_img1" src="pictures/pic1.png">
                <p class="percentage1">10%</p>
                <p class="brand_name1">ARMANI</p>
                <p class="product_name1">سوئیشرت</p>
        ...
        <div class="mySlides" style="display: none;">
            <p class="search_slider_text">صفحه 2 از 2</p>
            <!--row1col1-->
            <div class="pack1">
                <img class="pack_img1" src="pictures/pic2.png">
                <p class="percentage1">10%</p>
                <p class="brand_name1">ARMANI</p>
                <p class="product_name1">سوئیشرت</p>
                <strike class="before_off1">200</strike>
