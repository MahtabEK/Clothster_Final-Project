...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/cart item.css">
		<script type="text/javascript" src="js/cart item.js"></script>
	</head>
	...
	<body>
		...
		<img id="upCart" src="pictures/upHAHA.png">
		<img id="upCart_right" src="pictures/upHAHA_right.png">
		<img id="upCart_left" src="pictures/upHAHA_left.png">
		
		<div id="firstRow">
			<img id="firstRow_part1" src="pictures/firstRow_part1.png">
			<img id="firstRow_part2" src="pictures/firstRow_part2.png">
		</div>
		...
		<div class="item_in_cart">
			...
			<img class="column_Cart3" src="pictures/multiply.png">
	...
	<div id="orderForm">
		<form method="post" action="/cartItem/status">
			{!! csrf_field() !!}
		<p id="price">قیمت کل</p>
		<input id="price1" dir="rtl" name= "totalPrice" type="text" value="100">

		<p id="addresss">آدرس</p>
		<input id="address1" name="address" type="text">

			<p id="payment">نحوه پرداخت</p>
            <input id="payment1" name="paymentType" type="text">

			  <p id="p1">کد کالای اول</p>
              <input id="pp1" name="product1" type="text">

              <p id="p2">کد کالای دوم</p>
              <input id="pp2" name="product2" type="text">

              <p id="p3">کد کالای سوم</p>
              <input id="pp3" name="product3" type="text">

			<p id="n1">تعداد کالای اول</p>
			<input id="nn1" name="number1" type="text">

			<p id="n2">تعداد کالای دوم</p>
			<input id="nn2" name="number2" type="text">

			<p id="n3">تعداد کالای سوم</p>
			<input id="nn3" name="number3" type="text">

			<button type="submit"><img id="save_button" src="pictures/save_button.png"></button>
